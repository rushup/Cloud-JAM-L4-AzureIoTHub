...
#define EQ_NO_THREADS 

#include "azure_c_shared_utility/crt_abstractions.h"
#include "azure_c_shared_utility/platform.h"
#ifndef EQ_NO_THREADS
...
static const char* connectionString = "HostName=STM32IoTHub.azure-devices.net;DeviceId=0080E1B4D1FA;SharedAccessKey=Ag5Lxw8Pao4uZ73k4/ByyJt7Q2JqBOkJdbIjdB8Xltc=";
...
static bool send_reported(const PHYSICAL_DEVICE *physical_device, IOTHUB_CLIENT_HANDLE iotHubClientHandle)
{
  ...
  //  iot_device->iothubDM.firmwareVersion = device_get_firmware_version();
    device_get_firmware_version(iot_device->iothubDM.firmwareVersion);
...
int iothub_client_sample_mqtt_dm_run(void)
{
