...
static void NDEF_ReadURI_Geo ( struct sRecordInfo *pRecordStruct, sGeoInfo *pGeoStruct );
...
/**
  ...
  */
uint16_t NDEF_ReadGeo(struct sRecordInfo *pRecordStruct, sGeoInfo *pGeoStruct)
{
